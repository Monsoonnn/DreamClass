...
namespace EasyUI.PickerWheelUI
{
   ...
   public class PickerWheel : MonoBehaviour
   {
      ...
      private void DrawPiece(int index)
      {
         ...
         Transform pieceParent = InstantiatePiece().transform;
         Transform pieceTrns = pieceParent.GetChild(0);
      ...
      public void Spin(int targetIndex)
      {
         ...
         if (!_isSpinning)
         {
            ...
            .OnUpdate(() =>
            {
               // Force X and Y axes to 0 during rotation
